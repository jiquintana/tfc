...
class Headers:
    ...
    def output_parsed_headers(self):
        if self.DEBUG: print ('Headers.parsed_headers')
        ...
        for header_name, header_value in self.__response.headers.items():
            ...
            if (header_name == 'date'):
                ...
                if self.DEBUG:
                    ...
                    print('OU header SZ: %s -   : %s' % (self.port, len(self.__response.content)))
                pass
